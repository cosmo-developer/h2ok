...
H2OK_API H2OKResult CreateH2OKRunHookCallbackRegistrar(LPH2OKRunHookCallbackRegistrar);
H2OK_API H2OKResult GetH2OKRunHookCallbackCount(PH2OKRunHookCallbackRegistrar, int*);
